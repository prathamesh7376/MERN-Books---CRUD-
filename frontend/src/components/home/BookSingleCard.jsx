...
const BookSingleCard = ({ book }) => {
  ...
  return (
    <div className="border-2 border-gray-500 rounded-lg px-2 py-2 m-2 relative hover:shadow-xl w-full max-w-2xl md:max-w-3xl lg:max-w-4xl transition-all duration-300 ease-in-out">
      <h2 className="absolute top-4 right-2 px-2 py-1 bg-red-300 rounded-lg text-lg">
        {book.publishYear}
      </h2>
      <h4 className="my-2 text-gray-500 text-sm font-bold">{book._id}</h4>
